    ...
    <div className={`min-h-screen font-sans ${isDark ? 'dark bg-[#14120F] text-[#faf9f7]' : 'bg-[#faf9f7] text-[#14120F]'} transition-colors duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className={`text-sm font-medium px-4 py-2 rounded-md transition-colors ${isDark ? 'hover:bg-stone-800' : 'hover:bg-stone-200'}`}>
                Sign In
              </button>
              <button className="text-sm font-medium px-4 py-2 rounded-md text-white bg-gradient-to-r from-[#34d399] to-[#059669] hover:opacity-90 transition-opacity shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]">
                Get Started
              </button>
            </div>
          ...
          <div className={`md:hidden border-b ${isDark ? 'bg-[#14120F] border-stone-800' : 'bg-[#faf9f7] border-stone-200'}`}>
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <div className="mt-4 pt-4 border-t border-stone-200/20 px-3 space-y-2">
                <button className="w-full text-left px-3 py-2 text-base font-medium">Sign In</button>
                <button className="w-full text-center px-4 py-3 rounded-md text-white bg-gradient-to-r from-[#34d399] to-[#059669]">Get Started</button>
              </div>
            </div>
          </div>
        )}
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <button className="w-full sm:w-auto text-base font-medium px-6 py-3 rounded-md text-white bg-gradient-to-r from-[#34d399] to-[#059669] hover:opacity-90 transition-opacity shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]">
              Get Started Free
            </button>
      ...
      <section className={`py-24 relative overflow-hidden ${isDark ? 'bg-[#34d399]/5' : 'bg-[#34d399]/10'}`}>
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <button className="text-base font-medium px-8 py-4 rounded-md text-white bg-gradient-to-r from-[#34d399] to-[#059669] hover:opacity-90 transition-opacity shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)] mb-4">
